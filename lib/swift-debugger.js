...
module.exports = (SwiftDebugger = {
    ...
    consumeToolBar(getToolBar) {
        ...
        toolBar.addButton({ icon: 'bug', iconset: 'fa', callback: 'swift-debugger:debug', tooltip: 'Debug the executable.'});
        ...
        toolBar.addButton({ icon: 'arrow-up', iconset: 'fa', callback: 'swift-debugger:step-out', tooltip: 'Step to the next statement.'});
        toolBar.addButton({ icon: 'arrow-down', iconset: 'fa', callback: 'swift-debugger:step-in', tooltip: 'Step to the next statement.'});
