    ...
    */
    ...
    activate(state) {
        ...
        return this.subscriptions.add(atom.commands.add('atom-workspace', {
            ...
            'swift-debugger:debug': () => this.view(true).runApp(),
            'swift-debugger:stop': () => this.view(true).stopApp(),
            'swift-debugger:clear': () => this.view().clearOutput(),
            'swift-debugger:step-over': () => this.view(true).stepOverBtnPressed(),
            'swift-debugger:step-out': () => this.view(true).stepOverBtnPressed(),
            'swift-debugger:step-in': () => this.view(true).stepOverBtnPressed(),
