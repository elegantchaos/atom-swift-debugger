...
(SwiftDebuggerView = (function() {
  SwiftDebuggerView = class SwiftDebuggerView extends View {
    static initClass() {
      ...
      this.prototype.lldbPath = atom.config.get('atom-swift-debugger.lldb', {}) || 'lldb';
      this.prototype.swiftPath = atom.config.get('atom-swift-debugger.swift', {}) || 'swift';
    }
    ...
    static content() {
      return this.div({class: 'swiftDebuggerView'}, () => {
        ...
        this.button({outlet: 'runBtn', click: 'runApp', class: 'btn'}, () => {
          return this.span('run');
        });
        this.button({outlet: 'stopBtn', click: 'stopApp', class: 'btn'}, () => {
          return this.span('stop');
        });
        this.button({outlet: 'cleatBtn', click: 'clearOutput', class: 'btn'}, () => {
          return this.span('clear');
        });
        this.button({outlet: 'stepOver', click: 'stepOverBtnPressed', class: 'btn'}, () => {
          return this.span('next line');
        });
        this.button({outlet: 'resume', click: 'resumeBtnPressed', class: 'btn'}, () => {
          return this.span('resume');
        });
    ...
    activate(state) {
        console.debug("swift-debugger-view activate")
    }
    
    serialize() {
        console.debug("swift-debugger-view serialize")
      return {}
    }
